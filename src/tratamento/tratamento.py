...
class Tratamento:
    ...
    def limpar_descricao(self, textos: ResultSet) -> str:
        """
        ...
        for elemento in textos:
            if (not elemento.find('ul') and
                not elemento.find('div', class_='content-intertitle') and
                "LEIA TAMBÉM:" not in (elemento.text or '')):
